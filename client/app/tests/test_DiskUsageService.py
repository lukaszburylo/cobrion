...
def test_get_data_mocked(mock_disk_usage):
    ...
    response_dict = json.loads(str(data))  # use __str__ to get JSON string and parse it back
    output_data = ast.literal_eval(response_dict["output_data"])  # convert string dict to actual dict
